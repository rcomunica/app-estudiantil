        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h3 class="text-lg font-semibold text-gray-900">
                    @if ($editing)
                    Editando evento "{{$title}}" | #0{{$calendarId}}
                    @else
            ...
            <div class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Ingrese un titulo" wire:model='title' required="">
                    </div>
                    <div class="col-span-2">
                        <label for="date" class="block mb-2 text-sm font-medium text-gray-900">Fecha</label>
                        <input type="date" name="date" id="date"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            placeholder="" wire:model='date' required="">
                    </div>
                    <div class="col-span-2">
                ...
                <button type="submit" wire:click='store'
                    ...
                    @if ($editing)
                    Editar evento "{{$title}}" | #0{{$calendarId}}
                    @else
                    Crear evento
                    @endif
                </button>
